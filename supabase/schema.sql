...
-- ---------------------------------------------------------------------
-- 6. สถานะเครื่องตาม Alarm (เหมือน migrations/002_machine_status_from_alarms.sql)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 7. ปิดช่องโหว่สิทธิ์ (เหมือน migrations/003_harden_permissions.sql)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 8. สร้าง profile ให้ผู้ใช้ที่มีอยู่ก่อน (เหมือน migrations/004_backfill_profiles.sql)
-- ---------------------------------------------------------------------
insert into public.profiles (id, full_name)
